...
def main():
	...
	buttons[0].price = 5 # The starting price of the jump power upgrade
	buttons[1].typeIndicatorSprite = pygame.image.load('data/gfx/speed_indicator.png')
	buttons[1].price = 5 # The starting price of the speed upgrade
	buttons[2].typeIndicatorSprite = pygame.image.load('data/gfx/beanup_indicator.png')
	buttons[2].price = 30 # The starting price of the coffe bean upgrade 
	...
	while splashScreenTimer < 100:
		...
		# Show the Polymars logo on the start of the game
...
# If this file is being ran and not imported, run main()
